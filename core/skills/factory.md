---
name: factory
description: App Factory Autopilot 명령 라우터 — config/plan/init/auto/resume/review/status/doctor 위임
kind: entry
---
...
- plan/init/auto/resume 진입 시 프리플라이트로 `capability-audit`를 먼저 수행합니다

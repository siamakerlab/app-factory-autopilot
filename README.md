...
The package is published on npm as `app-factory-autopilot@0.1.12`.
...
```text
packages/app-factory-autopilot-claude-code-v0.1.12.tar.gz
packages/app-factory-autopilot-codex-v0.1.12.tar.gz
packages/SHA256SUMS
packages/README.md
```
...
```bash
cd packages
tar -xzf app-factory-autopilot-claude-code-v0.1.12.tar.gz
cd claude-code
./install-local.sh
```
...
```bash
cd packages
tar -xzf app-factory-autopilot-codex-v0.1.12.tar.gz
cd codex
./install-local.sh
```
